...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/l3aro/filament-tree.svg?style=flat-square)](https://packagist.org/packages/l3aro/filament-tree)
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/l3aro/filament-tree/run-tests.yml?branch=main&label=tests&style=flat-square)](https://github.com/l3aro/filament-tree/actions?query=workflow%3Arun-tests+branch%3Amain)
...
```bash
composer require l3aro/filament-tree
```
